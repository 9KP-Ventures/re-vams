...
import { GetDegreesRequest } from "@/lib/requests/degrees/get-many";
import { NextRequest, NextResponse } from "next/server";

// GET /api/degrees - List degrees with pagination and filtering
export async function GET(request: NextRequest) {
  const customRequest = new GetDegreesRequest(request);
