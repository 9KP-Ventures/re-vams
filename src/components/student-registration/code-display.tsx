...
export default function StudentCodeDisplay({ studentData }: Props) {
  ...
  const handleSaveQR = async () => {
    try {
      ...
      const canvasHeight = logoHeight + logoSpacing + qrSize + padding * 2 + textAreaHeight;
      ...
      ctx.drawImage(logo2, startX + logo1Width + 25, basePadding, logo2Width, baseLogoHeight);
      ...
      ctx.fillText("VSU Baybay Campus", canvasWidth / scaleFactor / 2, textStartY + 60);
